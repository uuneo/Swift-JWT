...
public class Log {
    ...
    private static var _logger: LoggerMain?
    ...
    public static var logger: LoggerMain? {
        get {
    ...
    private static var _swiftLogger: Logger?
    ...
    public static var swiftLogger: Logger? {
        get {
